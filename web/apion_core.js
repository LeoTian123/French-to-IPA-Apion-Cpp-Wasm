...
// include: C:\Users\Leo\AppData\Local\Temp\tmp80m0pv2p.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'web/apion_core.data';
      var REMOTE_PACKAGE_BASE = 'apion_core.data';
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_web/apion_core.data');
      }
      Module['addRunDependency']('datafile_web/apion_core.data');
    ...
    loadPackage({"files": [{"filename": "/exceptions.bin", "start": 0, "end": 4481135}], "remote_package_size": 4481135});

  })();

// end include: C:\Users\Leo\AppData\Local\Temp\tmp80m0pv2p.js
...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('apion_core.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('apion_core.wasm', import.meta.url).href;
